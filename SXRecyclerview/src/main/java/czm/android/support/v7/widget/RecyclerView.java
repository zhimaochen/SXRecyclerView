...
import czm.android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    final RecyclerViewDataObserver mObserver = new RecyclerViewDataObserver();
    ...
    private void dispatchLayoutStep1() {
        ...
        onStructureChanWhenLayout(mState.didStructureChange());
    }
    ...
    public final class Recycler {
        ...
        public View getViewForPosition(int position) {
            View view = getViewForPosition(position, false);
            setupChild(view,position);
            return view;
        }
    ...
    public static abstract class ItemDecoration {
         ...
         * @param state
         */
        public void onDrawOverChildren(Canvas c, RecyclerView parent, State state) {
        }


        /**
         * 画在Recyclerview前景的下层，ItemView的上层。该方法比onDrawOverChildren()方法画得更靠上层，但比onDrawOver()方法画的层级低
         * @param c
         * @param parent
         * @param state
         */
        public void onDrawUnderForeground(Canvas c, RecyclerView parent, State state) {
        }
